...
export function listBaselines(promptType?: string): string[] {
  ...
  const files = require('node:fs').readdirSync(BASELINE_DIR)
...
export function compareAgainstBaseline(
  ...
  const metrics = [
    ...
    { name: 'faithfulness', baseline: baselineEntry.semanticMetrics.faithfulness, current: current.semanticMetrics.faithfulness.score },
    { name: 'hallucination', baseline: baselineEntry.semanticMetrics.hallucination, current: current.semanticMetrics.hallucination.score },
    { name: 'relevance', baseline: baselineEntry.semanticMetrics.relevance, current: current.semanticMetrics.relevance.score },
    { name: 'completeness', baseline: baselineEntry.semanticMetrics.completeness, current: current.semanticMetrics.completeness.score },
  ];
