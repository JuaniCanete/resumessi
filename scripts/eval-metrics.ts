...
const TASK_KEYWORDS: Record<string, string[]> = {
  ...
  'cover-letter': ['dear', 'hiring', 'manager', 'position', 'experience', 'skill', 'interest'],
...
export function validateSchema<T>(output: unknown, schema: { parse: (data: unknown) => T }): { valid: boolean; errors: string[] } {
  try {
    schema.parse(output);
