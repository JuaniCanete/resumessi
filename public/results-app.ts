import { stripMarkdown, buildQueryUrl } from './utils';
...
// Elements that are always stripped from AI-rendered markdown to prevent XSS.
...
// Sanitize HTML generated by marked.parse() before injecting into the DOM.
    ...
    while (child) {
      ...
      if (child.nodeType === Node.ELEMENT_NODE) {
        ...
        if (DANGEROUS_TAGS.has(tag)) {
          ...
          // Strip event handlers and dangerous URL schemes from attributes
